...
public class Passenger 
{
	...
	public int pass_type; //1=express, 2= specNeeds, 3=precheck, 4=regular //only used for model b
	...
	{
		id_check_time = Driver.Distributions.generateIDCheckTime();
	}

	public void setMm_scan_time() 
	{
        mm_scan_time = Driver.Distributions.generateMmScanTime();
	}


	public void setXray_scan_time() 
	{
		xray_scan_time = Driver.Distributions.generateXrayScanTime();
	}

	public void setProperty_collect_time() 
	{
		property_collect_time = Driver.Distributions.generatePropertyCollectTime();
	}

	public void setTsa_precheck() 
	{
		tsa_precheck = Driver.Distributions.generatePrecheckValue();
	}
